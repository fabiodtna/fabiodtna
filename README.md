...
Olá, meu nome é **Fábio H**, sou **programador Full-Stack** com conhecimentos em **segurança da informação**. Tenho experiência em desenvolver soluções de software e hardware personalizadas, além de realizar análises de segurança para empresas e indivíduos.

Minhas habilidades incluem:

- Linguagens de programação: React, C, C++, PHP, JavaScript, C#  
...
Olá, meu nome é Fábio, sou programador Full-Stack com conhecimentos em segurança da informação. Tenho experiência em desenvolver soluções de software e hardware personalizadas de acordo com o cliente, e também realizo análise de segurança para empresas e indivíduos.
